...
message = f"""I have run the script consensus_metrics.py and generated several datasets.
 ...
 Report the most significant findings available in the lda, sentiments and clusters objects and explain what they show.
 ...
 Report actual values extracted from the datasets I provided.
 You may also provide recommendations for additional analyses I might like to run, and recommendations for what we could do to advance the conversation.
